...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      {/* Mobile Frame Container - Reduced height to fit better */}
      <div className="relative w-full max-w-sm h-[550px] bg-black rounded-3xl shadow-2xl overflow-hidden border-8 border-gray-800">
